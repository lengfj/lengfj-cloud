package com.lengfj.cloud.leaf.core.snowflake;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.google.common.collect.Maps;
import com.lengfj.cloud.common.core.util.SpringContextUtil;
import com.lengfj.cloud.leaf.core.snowflake.exception.CheckLastTimeException;
...
public class SnowflakeZookeeperHolder {
    ...
    private static final String PREFIX_ZK_PATH = "/snowflake/" + SpringContextUtil.getApplicationName();
    private static final String PROP_PATH = System.getProperty("java.io.tmpdir") + File.separator + SpringContextUtil.getApplicationName() + "/leafconf/{port}/workerID.properties";
