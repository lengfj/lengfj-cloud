...
import com.lengfj.cloud.dynamic.pagination.starter.feign.dto.PageUserConfigDTO;
import com.lengfj.cloud.dynamic.pagination.starter.feign.vo.PageListConfigVO;
...
@FeignClient(name = "lengfj-dynamic-pagination-api", path = "/lengfj-dynamic-pagination-api/rpc/pageUserConfig", contextId = "pageUserConfigApi")
